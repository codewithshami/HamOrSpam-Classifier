...
# App UI
def main():
    st.set_page_config(page_title="HamOrSpam", layout="wide", page_icon="🛡️")
    ...
    st.title("🛡️ HamOrSpam - AI Email Classifier")
    st.markdown("""
    **AI-powered HamOrSpam detection with comprehensive analytics and real-time protection.**
    ...
    st.markdown("""
    <div class="footer">
        <p>Developed with ❤️ by Mohd Shami | HamOrSpam Pro v2.1 | © 2025 All rights reserved</p>
    </div>
    """, unsafe_allow_html=True)
